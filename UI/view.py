...
class View():
    ...
    def load_interface(self):
        ...
        self._ddAnno = ft.Dropdown(
            label="Anno",
            width=200,
            alignment=Alignment(-1, -1) , on_change=self._controller.handleAnno # top-left
        )
        ...
        cont = ft.Container(self._txtOutSquadre, width=300, height= 200,   alignment=Alignment(-1, -1), bgcolor="#deeded")
